  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">Educine?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than Educine, the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of Educine, I know firsthand the challenges
          ...
          <br />
          <br />
          At Educine, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But Educine is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With Educine by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the Educine family today and let&apos;s
        ...
        <br />
        <span className="text-[22px]">Sindhant Kumar&apos;s</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of Educine
        </h5>
        <br />
        <br />
        <br />
